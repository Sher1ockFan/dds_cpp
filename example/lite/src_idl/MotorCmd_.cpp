...
propvec &get_type_props<::pnd_adam::msg::dds_::MotorCmd_>() {
  ...
  props.push_back(entity_properties_t(1, 6, false, get_bit_bound<float>(), extensibility::ext_final, false));  //::ki
  props.push_back(entity_properties_t(1, 7, false, get_bit_bound<uint32_t>(), extensibility::ext_final, false));  //::reserve

...
class PublisherBase : public pndbotics::robot::ChannelPublisher<MessageType>
{
public:
  ...
  : pndbotics::robot::ChannelPublisher<MessageType>(TOPIC_NAME)
  {
    this->InitChannel();
  }
};
...
public:
  using MsgType = MessageType;
  using PublisherSharedPtr = typename pndbotics::robot::ChannelPublisherPtr<MessageType>;

...
class LowState : public SubscriptionBase<pndbotics_go::msg::dds_::LowState_>
{
public:
...
class LowCmd : public SubscriptionBase<pndbotics_go::msg::dds_::LowCmd_>
{
public:
...
class SportModeState : public SubscriptionBase<pndbotics_go::msg::dds_::SportModeState_>
{
public:
...
class MotorStates : public SubscriptionBase<pndbotics_go::msg::dds_::MotorStates_>
{
public:
  using SharedPtr = std::shared_ptr<pndbotics_go::msg::dds_::MotorStates_>;
...
class MotorCmds : public SubscriptionBase<pndbotics_go::msg::dds_::MotorCmds_>
{
public:
  using SharedPtr = std::shared_ptr<pndbotics_go::msg::dds_::MotorCmds_>;

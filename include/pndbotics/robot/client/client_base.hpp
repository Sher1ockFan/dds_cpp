#ifndef __PND_ROBOT_SDK_CLIENT_BASE_HPP__
#define __PND_ROBOT_SDK_CLIENT_BASE_HPP__

#include <pndbotics/robot/client/client_stub.hpp>
...
#endif//__PND_ROBOT_SDK_CLIENT_BASE_HPP__

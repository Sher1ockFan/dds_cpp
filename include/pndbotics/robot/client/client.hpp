#ifndef __PND_ROBOT_SDK_CLIENT_HPP__
#define __PND_ROBOT_SDK_CLIENT_HPP__

#include <pndbotics/robot/client/client_base.hpp>
#include <pndbotics/robot/client/lease_client.hpp>

#define PND_ROBOT_CLIENT_REG_API_NO_PROI(apiId) \
    PND_ROBOT_CLIENT_REG_API(apiId, 0)

#define PND_ROBOT_CLIENT_REG_API(apiId, priority) \
...
#endif//__PND_ROBOT_SDK_CLIENT_HPP__

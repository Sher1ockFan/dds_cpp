#ifndef __PND_ROBOT_B2_SPORT_CLIENT_HPP__
#define __PND_ROBOT_B2_SPORT_CLIENT_HPP__
...
public:
    ...
    int32_t TrajectoryFollow(std::vector<pndbotics::robot::b2::PathPoint> &path);
...
#endif//__PND_ROBOT_B2_SPORT_CLIENT_HPP__

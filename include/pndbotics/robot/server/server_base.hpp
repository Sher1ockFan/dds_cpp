#ifndef __PND_ROBOT_SDK_SERVER_BASE_HPP__
#define __PND_ROBOT_SDK_SERVER_BASE_HPP__

#include <pndbotics/robot/server/server_stub.hpp>
...
#endif//__PND_ROBOT_SDK_SERVER_BASE_HPP__

#ifndef __PND_ROBOT_SDK_CHANNEL_LABOR_HPP__
#define __PND_ROBOT_SDK_CHANNEL_LABOR_HPP__

#include <pndbotics/robot/channel/channel_factory.hpp>
#include <pndbotics/robot/channel/channel_namer.hpp>
...
#endif//__PND_ROBOT_SDK_CHANNEL_LABOR_HPP__

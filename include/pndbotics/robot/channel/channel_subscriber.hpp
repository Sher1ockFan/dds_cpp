#ifndef __PND_ROBOT_SDK_CHANNEL_SUBSCRIBER_HPP__
#define __PND_ROBOT_SDK_CHANNEL_SUBSCRIBER_HPP__
...
public:
    ...
    void InitChannel()
    {
        ...
        {
            PND_THROW(common::CommonException, "subscribe handler is invalid");
        }
    }
...
#endif//__PND_ROBOT_SDK_CHANNEL_SUBSCRIBER_HPP__

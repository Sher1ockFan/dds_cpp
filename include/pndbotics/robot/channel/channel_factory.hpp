#ifndef __PND_ROBOT_SDK_CHANNEL_FACTORY_HPP__
#define __PND_ROBOT_SDK_CHANNEL_FACTORY_HPP__

#include <pndbotics/common/dds/dds_factory_model.hpp>
...
using Channel = pndbotics::common::DdsTopicChannel<MSG>;

template<typename MSG>
using ChannelPtr = pndbotics::common::DdsTopicChannelPtr<MSG>;
...
#endif//__PND_ROBOT_SDK_CHANNEL_FACTORY_HPP__

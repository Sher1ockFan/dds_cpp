#ifndef __PND_ROBOT_G1_AUDIO_CLIENT_HPP__
#define __PND_ROBOT_G1_AUDIO_CLIENT_HPP__
...
class AudioClient : public Client {
 public:
  ...
  void Init() {
    ...
    PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_AUDIO_TTS);
    PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_AUDIO_ASR);
    PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_AUDIO_START_PLAY);
    PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_AUDIO_STOP_PLAY);
    PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_AUDIO_GET_VOLUME);
    PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_AUDIO_SET_VOLUME);
    PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_AUDIO_SET_RGB_LED);
  };
  ...
  int32_t GetVolume(uint8_t& volume) {
    ...
    if (ret == 0) {
      pndbotics::robot::go2::JsonizeCommObjInt json;
      json.name = "volume";
...
#endif  // __PND_ROBOT_G1_AUDIO_CLIENT_HPP__

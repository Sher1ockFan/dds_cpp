...
#include <pndbotics/idl/hg/BmsState_.hpp>
...
inline bool bad_orientation(const pndbotics_hg::msg::dds_::LowState_ & lowstate, float limit_angle = 1.0)
{
...
inline bool joint_vel_out_of_limit(const pndbotics_hg::msg::dds_::LowState_ & lowstate, float limit_vel = 10.0)
{
...
inline bool ang_vel_out_of_limit(const pndbotics_hg::msg::dds_::LowState_ & lowstate, float limit_vel = 6.0)
{
...
inline bool motor_winding_overheat(const pndbotics_hg::msg::dds_::LowState_ & lowstate, float limit_temp = 120.0)
{
    auto & motors = lowstate.motor_state();
...
inline bool motor_casing_overheat(const pndbotics_hg::msg::dds_::LowState_ & lowstate, float limit_temp = 85.0)
{
    auto & motors = lowstate.motor_state();
    return std::any_of(motors.begin(), motors.end(), [limit_temp](const auto & motor) {
...
inline bool low_battery(const  pndbotics_hg::msg::dds_::BmsState_ & bms_state, float limit_soc = 20.0)
{
 ...
 */
inline bool lost_connection(pndbotics::robot::ChannelSubscriberPtr<pndbotics_hg::msg::dds_::LowState_> & subscriber, int64_t timeout_ms = 1000)
{
    auto now = pndbotics::common::GetCurrentMonotonicTimeNanosecond();

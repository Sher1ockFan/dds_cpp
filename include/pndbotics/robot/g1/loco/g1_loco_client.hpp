#ifndef __PND_ROBOT_G1_LOCO_CLIENT_HPP__
#define __PND_ROBOT_G1_LOCO_CLIENT_HPP__
...
class LocoClient : public Client {
 public:
  ...
  void Init() {
    ...
    PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_LOCO_SET_SPEED_MODE);
  };
...
#endif // __PND_ROBOT_G1_LOCO_CLIENT_HPP__

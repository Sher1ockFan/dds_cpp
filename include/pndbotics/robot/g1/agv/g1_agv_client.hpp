#ifndef __PND_ROBOT_G1_AGV_CLIENT_HPP__
#define __PND_ROBOT_G1_AGV_CLIENT_HPP__
...
public:
    ...
    void Init() {
        ...
        PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_AGV_MOVE);
        PND_ROBOT_CLIENT_REG_API_NO_PROI(ROBOT_API_ID_AGV_HEIGHT_ADJUST);
    };
...
#endif // __PND_ROBOT_G1_AGV_CLIENT_HPP__

#ifndef __PND_ROBOT_GO2_CONFIG_CLIENT_HPP__
#define __PND_ROBOT_GO2_CONFIG_CLIENT_HPP__

#include <pndbotics/robot/client/client.hpp>
#include <pndbotics/robot/channel/channel_subscriber.hpp>
#include <pndbotics/idl/go2/ConfigChangeStatus_.hpp>
...
private:
    pndbotics::common::Mutex mLock;
    std::map<std::string,ConfigChangeStatusCallback> mNameCallbackMap;
    ChannelSubscriberPtr<pndbotics_go::msg::dds_::ConfigChangeStatus_> mSubscriberPtr;
};
...
#endif//__PND_ROBOT_GO2_CONFIG_CLIENT_HPP__

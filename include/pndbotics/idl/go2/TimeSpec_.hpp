...
*****************************************************************/
#ifndef DDSCXX_pndbotics_IDL_GO2_TIMESPEC__HPP
#define DDSCXX_pndbotics_IDL_GO2_TIMESPEC__HPP
...
template <> constexpr const char* TopicTraits<::pndbotics_go::msg::dds_::TimeSpec_>::getTypeName()
{
  return "pndbotics_go::msg::dds_::TimeSpec_";
}

template <> constexpr bool TopicTraits<::pndbotics_go::msg::dds_::TimeSpec_>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::pndbotics_go::msg::dds_::TimeSpec_>::type_map_blob_sz() { return 258; }
template<> constexpr unsigned int TopicTraits<::pndbotics_go::msg::dds_::TimeSpec_>::type_info_blob_sz() { return 100; }
template<> inline const uint8_t * TopicTraits<::pndbotics_go::msg::dds_::TimeSpec_>::type_map_blob() {
...
template<> inline const uint8_t * TopicTraits<::pndbotics_go::msg::dds_::TimeSpec_>::type_info_blob() {
  static const uint8_t blob[] = {
...
template <>
struct topic_type_name<::pndbotics_go::msg::dds_::TimeSpec_>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::pndbotics_go::msg::dds_::TimeSpec_>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::pndbotics_go::msg::dds_::TimeSpec_)
...
template<>
propvec &get_type_props<::pndbotics_go::msg::dds_::TimeSpec_>();

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::pndbotics_go::msg::dds_::TimeSpec_& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::pndbotics_go::msg::dds_::TimeSpec_& instance, bool as_key) {
  auto &props = get_type_props<::pndbotics_go::msg::dds_::TimeSpec_>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::pndbotics_go::msg::dds_::TimeSpec_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::pndbotics_go::msg::dds_::TimeSpec_& instance, bool as_key) {
  auto &props = get_type_props<::pndbotics_go::msg::dds_::TimeSpec_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::pndbotics_go::msg::dds_::TimeSpec_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::pndbotics_go::msg::dds_::TimeSpec_& instance, bool as_key) {
  auto &props = get_type_props<::pndbotics_go::msg::dds_::TimeSpec_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::pndbotics_go::msg::dds_::TimeSpec_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::pndbotics_go::msg::dds_::TimeSpec_& instance, bool as_key) {
  auto &props = get_type_props<::pndbotics_go::msg::dds_::TimeSpec_>();
...
#endif // DDSCXX_pndbotics_IDL_GO2_TIMESPEC__HPP

#ifndef __PND_DDS_SERVICE_HPP__
#define __PND_DDS_SERVICE_HPP__

#include <pndbotics/common/service/base/service_base.hpp>
#include <pndbotics/common/service/base/service_config.hpp>
...
public:
    DdsService()
    {
        mLogger = GetLogger("/pndbotics/service/dds_service");
        mQuit = false;
    }

#ifndef __PND_LOCK_HPP__
#define __PND_LOCK_HPP__
...
enum
{
    PND_LOCK_MODE_READ   = 0,
    PND_LOCK_MODE_WRITE  = 1,
    PND_LOCK_MODE_UNLCK  = 2
};

enum
{
    PND_LOCK_ENO_INTR     = EINTR,
    PND_LOCK_ENO_BUSY     = EBUSY,
    PND_LOCK_ENO_TIMEDOUT = ETIMEDOUT
};

#ifndef __PND_STRING_TOOL_HPP__
#define __PND_STRING_TOOL_HPP__
 ...
 * trim delim
 */
const char PND_TRIM_DELIM_STR[] = {0x09,0x0A,0x0B,0x0C,0x0D,0x20,0x00};
...
std::string& TrimLeft(std::string& s, const std::string& delim = std::string(PND_TRIM_DELIM_STR));
std::string& TrimRight(std::string& s, const std::string& delim = std::string(PND_TRIM_DELIM_STR));
std::string& Trim(std::string& s, const std::string& delim = std::string(PND_TRIM_DELIM_STR));

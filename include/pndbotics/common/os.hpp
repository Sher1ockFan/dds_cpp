#ifndef __PND_OS_HPP__
#define __PND_OS_HPP__
...
namespace common
{
enum PND_SCHED_POLICY
{
    PND_SCHED_POLICY_NORMAL = SCHED_OTHER,
    PND_SCHED_POLICY_FIFO = SCHED_FIFO,
    PND_SCHED_POLICY_RR = SCHED_RR,
    PND_SCHED_POLICY_BATCH = SCHED_BATCH,
    PND_SCHED_POLICY_IDLE = SCHED_IDLE,
    PND_SCHED_POLICY_DEADLINE = SCHED_DEADLINE
};

#ifndef __PND_LOG_POLICY_HPP__
#define __PND_LOG_POLICY_HPP__
...
public:
    ...
    LogStorePolicy(const std::string& name, int32_t type, int32_t fileNumber, int64_t fileSize,
        int64_t fileWriteInter = PND_LOG_WRITE_INTER, int32_t cpuId = PND_CPU_ID_NONE,

...
#include <pndbotics/common/dds/dds_topic_channel.hpp>
#include <pndbotics/common/dds/dds_parameter.hpp>
#include <pndbotics/common/dds/dds_qos_realize.hpp>
#include <pndbotics/common/string_tool.hpp>

#define PND_DDS_PARAMETER_CONFIG_FILENAME "dds_parameter.json"
...
public:
    ...
    void SetTopic(const std::string& topic)
    {
        ...
        {
            PND_THROW(CommonException, std::string("topic reader is already exist. topic:") + topic);
        }
    }

#ifndef __PND_DDS_TOPIC_CHANNEL_HPP__
#define __PND_DDS_TOPIC_CHANNEL_HPP__

#include <pndbotics/common/dds/dds_entity.hpp>
...
#define PND_DDS_WAIT_MATCHED_TIME_MICRO_SEC 100000
...
public:
    ...
    void SetWriter(const DdsPublisherPtr& publisher, const DdsWriterQos& qos)
    {
        ...
        MicroSleep(PND_DDS_WAIT_MATCHED_TIME_MICRO_SEC);
    }
...
#endif//__PND_DDS_TOPIC_CHANNEL_HPP__

...
{
    GetNumberField<int64_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_PEROID, mPeriod);
    Update();
}
...
{
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_KIND, mKind);
    Update();
}
...
{
    GetNumberField<int64_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_CLEANUP_DELAY, mCleanupDelay);
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_HISTORY_KIND, mHistoryKind);
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_HISTORY_DEPTH, mHistoryDepth);
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_MAX_SAMPLES, mMaxSamples);
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_MAX_INSTANCES, mMaxInstances);
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_MAX_SAMPLES_PER_INSTANCE, mMaxSamplesPerInstance);
    Update();
}
...
{
    GetField<bool>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_AUTO_ENABLE, mAutoEnable);
    Update();
}
...
{
    auto it = data.find(UT_DDS_QOS_POLICY_MEMBER_NAME_VALUE);
...
{
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_KIND, mKind);
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_DEPTH, mDepth);
    Update();
}
...
{
    GetNumberField<int64_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_DURATION, mDuration);
    Update();
}
...
{
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_KIND, mKind);
    GetNumberField<int64_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_LEASE_DURATION, mLeaseDuration);
    Update();
}
...
{
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_VALUE, mValue);
    Update();
}
...
{
    GetField<std::string>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_NAME, mName);
    Update();
}
...
{
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_ACCESS_SCOPE, mAccessScopeKind);
    GetField<bool>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_COHERENT_ACCESS, mCoherentAccess);
    GetField<bool>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_ORDERED_ACCESS, mOrderedAccess);
    Update();
}
...
{
    GetNumberField<int64_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_AUTOPURGE_NOWRITER_SAMPLES_DELAY, mAutopurgeNowriterSamplesDelay);
    GetNumberField<int64_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_AUTOPURGE_DISPOSED_SAMPLES_DELAY, mAutopurgeDisposedSamplesDelay);
    Update();
}
...
{
    GetNumberField<int32_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_KIND, mKind);
    GetNumberField<int64_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_MAX_BLOCKING_TIME, mMaxBlockingTime);
    Update();
}
...
{
    GetNumberField<int64_t>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_MIN_SEP, mMinSep);
    Update();
}
...
{
    GetField<bool>(data, UT_DDS_QOS_POLICY_MEMBER_NAME_AUTODISPOSE_UNREGISETED_INSTANCES, mAutodisposeUnregisteredInstances);
    Update();
}
